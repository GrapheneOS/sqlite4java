...
// Complex declarations are commented out with "// --MANUAL-- ".
...
*/
// --OUT-- #ifndef _SQLITE3_H_
// --OUT-- #define _SQLITE3_H_
// --OUT-- #include <stdarg.h>     /* Needed for the definition of va_list */
...
*/
// --OUT-- #ifndef SQLITE_EXTERN
// --OUT-- # define SQLITE_EXTERN extern
// --OUT-- #endif
...
** file.
*/
// --OUT-- #ifdef SQLITE_VERSION
// --OUT-- # undef SQLITE_VERSION
// --OUT-- #endif
// --OUT-- #ifdef SQLITE_VERSION_NUMBER
// --OUT-- # undef SQLITE_VERSION_NUMBER
// --OUT-- #endif
...
*/
// --OUT-- #define SQLITE_VERSION         "3.5.2"
// --OUT-- #define SQLITE_VERSION_NUMBER 3005002
...
*/
// --OUT-- SQLITE_EXTERN const char sqlite3_version[];
...
*/
// --OUT-- #ifdef SQLITE_OMIT_FLOATING_POINT
// --OUT-- # define double sqlite3_int64
// --OUT-- #endif
...
*/
// --MANUAL-- typedef int (*sqlite3_callback)(void*,int,char**, char**);
...
**
*/
// --MANUAL-- int sqlite3_exec(
// --MANUAL--   sqlite3*,                                  /* An open database */
// --MANUAL--   const char *sql,                           /* SQL to be evaluted */
// --MANUAL--   int (*callback)(void*,int,char**,char**),  /* Callback function */
// --MANUAL--   void *,                                    /* 1st argument to callback */
// --MANUAL--   char **errmsg                              /* Error msg written here */
// --MANUAL-- );
...
** is defined.
*/
// --OUT-- #define SQLITE_FCNTL_LOCKSTATE        1
...
*/
// --OUT-- typedef struct sqlite3_mutex sqlite3_mutex;
...
// --OUT-- int sqlite3_complete16(const void *sql);
...
*/
// --MANUAL-- int sqlite3_busy_handler(sqlite3*, int(*)(void*,int), void*);
...
** information.
*/
// --OUT-- #define SQLITE_DENY   1   /* Abort the SQL statement with an error */
// --OUT-- #define SQLITE_IGNORE 2   /* Don't allow access, but don't generate an error */
...
*/
// --MANUAL-- void sqlite3_progress_handler(sqlite3*, int, int(*)(void*), void*);
...
// --OUT-- const void *sqlite3_errmsg16(sqlite3*);
...
*/
// --OUT-- typedef struct Mem sqlite3_value;
...
*/
// --OUT-- typedef struct sqlite3_context sqlite3_context;
...
*/
// --MANUAL-- int sqlite3_bind_blob(sqlite3_stmt*, int, const void*, int n, void(*)(void*));
int sqlite3_bind_double(sqlite3_stmt*, int, double);
int sqlite3_bind_int(sqlite3_stmt*, int, int);
int sqlite3_bind_int64(sqlite3_stmt*, int, sqlite3_int64);
int sqlite3_bind_null(sqlite3_stmt*, int);
// --MANUAL-- int sqlite3_bind_text(sqlite3_stmt*, int, const char*, int n, void(*)(void*));
// --OUT-- int sqlite3_bind_text16(sqlite3_stmt*, int, const void*, int, void(*)(void*));
// --OUT-- int sqlite3_bind_value(sqlite3_stmt*, int, const sqlite3_value*);
...
// --OUT-- const void *sqlite3_column_name16(sqlite3_stmt*, int N);
...
// --OUT-- const void *sqlite3_column_database_name16(sqlite3_stmt*,int);
const char *sqlite3_column_table_name(sqlite3_stmt*,int);
// --OUT-- const void *sqlite3_column_table_name16(sqlite3_stmt*,int);
const char *sqlite3_column_origin_name(sqlite3_stmt*,int);
// --OUT-- const void *sqlite3_column_origin_name16(sqlite3_stmt*,int);
...
// --OUT-- const void *sqlite3_column_decltype16(sqlite3_stmt*,int);
...
// --OUT-- const void *sqlite3_column_text16(sqlite3_stmt*, int iCol);
int sqlite3_column_type(sqlite3_stmt*, int iCol);
// --OUT-- sqlite3_value *sqlite3_column_value(sqlite3_stmt*, int iCol);
...
*/
// --OUT-- void *sqlite3_aggregate_context(sqlite3_context*, int nBytes);
...
*/
// --OUT-- void *sqlite3_user_data(sqlite3_context*);
...
** the SQL function is running.
*/
// --OUT-- void *sqlite3_get_auxdata(sqlite3_context*, int);
// --OUT-- void sqlite3_set_auxdata(sqlite3_context*, int, void*, void (*)(void*));
...
*/
// --OUT-- typedef void (*sqlite3_destructor_type)(void*);
// --OUT-- #define SQLITE_STATIC      ((sqlite3_destructor_type)0)
// --OUT-- #define SQLITE_TRANSIENT   ((sqlite3_destructor_type)-1)
...
*/
// --OUT-- SQLITE_EXTERN char *sqlite3_temp_directory;
